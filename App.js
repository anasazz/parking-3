...
const App = () => {
  ...
  const [fontsLoaded, error] = useFonts({
    ...
    DM_Sans: require("./assets/fonts/DM_Sans.ttf"),
    DM_Sans_regular : require("./assets/fonts/DM_Sans_regular.ttf"),
    DM_Sans_medium : require("./assets/fonts/DM_Sans_medium.ttf"),
    DM_Sans_bold : require("./assets/fonts/DM_Sans_bold.ttf"),
